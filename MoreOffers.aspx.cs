...
public partial class MoreOffers : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            string s3 = Convert.ToString(Request.QueryString["catagory"]);
...
//s3 = Convert.ToString(Session["dataset"]);
              //  ds2 = bind(s3);
                ...
                for (int i = 0; i < tmpDS.Tables[0].Rows.Count; i++)
                {
                    ...
                    if (a == s1)
                    {
                        ...
                        if (lbltitle.Text == "Others")
                        {
                            lbltitle.Text = "Other Offers";
                        }

                        if (lbltitle.Text == "Food Items")
                        {
                            lbltitle.Text = "Food Offers";
                        }
                        if (lbltitle.Text == "Top Coupons ")
                        {
                            lbltitle.Text = "Top Coupons & Offers Of the Day ";
    ...
    protected void DataList1_ItemCommand1(object source, DataListCommandEventArgs e)
    {
        if (e.CommandName == "coupon")
        {
            ...
            Response.Redirect("MoreOffers.aspx?tag=" + CustomerID +"&title="+x);
        }
    }
    ...
    protected void lnktop_Click(object sender, EventArgs e)
    {
        ...
        hot.Visible = true;
        hot1.Visible = true;
        Response.Redirect("MoreOffers.aspx?priority=" + prio + "&title=" + lbltitle.Text);
    }
